...
import numpy as np
import logging
from src.utils.callbacks import create_and_save_checkpoint_callback,create_and_save_tensorboard_callback,get_callbacks
from src.all_utils import read_yaml,save_local_df,save_reports,create_directory
import argparse
import os
...
def prepare_callbacks(config_path, params_path):
    ...
    callbacks_dir = os.path.join(artifacts_dir, artifacts["CALL_BACK_DIR"])
